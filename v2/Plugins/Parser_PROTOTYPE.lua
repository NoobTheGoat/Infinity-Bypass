...
parse_selection.Click:Connect(function()
	...
	print("Attempting To Parse MainModule!")

	local DataJSON = parseChildren(SS.Asset, {["Children"] = {}, ["ClassName"] = "nil"}, true)

	print("Parsed MainModule Successfully!")

	print("Attempting To Upload JSON data!")

	local data = game.HttpService:JSONEncode(DataJSON)
