...
local perms = HttpService:GetAsync("https://pastebin.com/raw/rTMcqaKU") --// Asks for perms for access to pastebin
...
local function getClassProperties()
	local ClassProperties do
		...
		local RobloxAPIJSON = HttpService:GetAsync("https://pastebin.com/raw/rTMcqaKU")
		local Data = HttpService:JSONDecode(RobloxAPIJSON) 
		for i = 1, #Data do
			local Table = Data[i]
